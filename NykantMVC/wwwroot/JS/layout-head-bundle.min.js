AddAntiforgeryToken=function(n){var t=$("#AntiforgeryToken input[name=AntiforgeryToken]").val();return n.AntiforgeryToken=t,n};var Log=function(n){$.ajax({type:"POST",url:"/Home/Log",data:AddAntiforgeryToken({message:n})})};
/*!
