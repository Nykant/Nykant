    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, Name = "Nora", Price = 1000, CategoryId = 1, Description = "Vores tøjstativ ”Nora” er udviklet i et system hvor det samles uden skruer og lim, men udelukkende med kiler i massiv egetræ. Detaljen i sig selv er både meget nem at samle og skille, men viser måske i endnu højere grad nogle meget smukke og enkle detaljer, Der klæder møblet med en meget høj snedkermæssig niveau.", LastModified = DateTime.Now, Path = "wwwroot/images/gyngestol.jpg", ImageSource = "../images/Finback-Chairs1-1280x853-c-default.jpg", ImageSource2 = "../images/Products/NYKANT_boejle_hvidolie_01.png", TypeOfWood = "Eg", ItemType = "Tøjstativ", Size = "5mm", Oil = "naturligt", WeightInKg = 11.6 },
                ...
                new Product { Id = 4, Title = "Grøntsags Skærebræt", Name = "Grøntsags Skærebræt", Price = 1000, CategoryId = 4, Description = "a test object", LastModified = DateTime.Now, Path = "wwwroot/images/gyngestol.jpg", ImageSource = "../images/Finback-Chairs1-1280x853-c-default.jpg", ImageSource2 = "../images/gyngestol.jpg", TypeOfWood = "eg", ItemType = "skærebræt", Size = "5mm", Oil = "farvet-overflade", WeightInKg = 7 },
