    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, Name = "Nora", Price = 1000, CategoryId = 5, Description = "Bøjlen.", ImageSource = "../images/Products/NYKANT_boejle_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_boejle_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 11.6 },
                 new Product { Id = 2, Name = "Nora", Price = 1000, CategoryId = 5, Description = "Bøjlen.", ImageSource = "../images/Products/NYKANT_boejle_sortolie_01.png", ImageSource2 = "../images/Products/NYKANT_boejle_sortolie_02.png", TypeOfWood = "Eg", Oil = "Sortolie", WeightInKg = 11.6 },
                 new Product { Id = 3, Name = "Nora", Price = 1000, CategoryId = 5, Description = "Bøjlen.", ImageSource = "../images/Products/NYKANT_boejle_hvidolie_01.png", ImageSource2 = "../images/Products/NYKANT_boejle_hvidolie_02.png", TypeOfWood = "Eg", Oil = "Hvidolie", WeightInKg = 11.6 },
                 new Product { Id = 4, Name = "Nora", Price = 1000, CategoryId = 3, Description = "Hylden.", ImageSource = "../images/Products/NYKANT_hylde_hvidolie_01.png", ImageSource2 = "../images/Products/NYKANT_hylde_hvidolie_02.png", TypeOfWood = "Eg", Oil = "Hvidolie", WeightInKg = 11.6 }, 
                 new Product { Id = 5, Name = "Nora", Price = 1000, CategoryId = 3, Description = "Hylden.", ImageSource = "../images/Products/NYKANT_hylde_sortolie_01.png", ImageSource2 = "../images/Products/NYKANT_hylde_sortolie_02.png", TypeOfWood = "Eg", Oil = "Sortolie", WeightInKg = 11.6 }, 
                 new Product { Id = 6, Name = "Nora", Price = 1000, CategoryId = 3, Description = "Hylden.", ImageSource = "../images/Products/NYKANT_hylde_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_hylde_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 11.6 }, 
                 new Product { Id = 7, Name = "Nora", Price = 1000, CategoryId = 2, Description = "Bordet.", ImageSource = "../images/Products/NYKANT_bord_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_bord_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 11.6 },
                new Product { Id = 8, Name = "Nora", Price = 1000, CategoryId = 4, Description = "Den korte bænk", ImageSource = "../images/Products/NYKANT_kortbaenk_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_kortbaenk_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 13.4 },
                new Product { Id = 9, Name = "Nora", Price = 1000, CategoryId = 4, Description = "Den lange bænk", ImageSource = "../images/Products/NYKANT_langbaenk_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_langbaenk_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 13.4 },
                new Product { Id = 10, Name = "Grete", Price = 1000, CategoryId = 4, Description = "Opbevaringsbænk", ImageSource = "../images/Products/NYKANT_opbevaringsbaenk_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_opbevaringsbaenk_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 13.4 },
                new Product { Id = 11, Name = "Ingrid", Price = 1000, CategoryId = 1, Description = "Vores tøjstativ ”Nora” er udviklet i et system hvor det samles uden skruer og lim, men udelukkende med kiler i massiv egetræ. Detaljen i sig selv er både meget nem at samle og skille, men viser måske i endnu højere grad nogle meget smukke og enkle detaljer, Der klæder møblet med en meget høj snedkermæssig niveau.", ImageSource = "../images/Products/NYKANT_rack_naturolie_01.png", ImageSource2 = "../images/Products/NYKANT_rack_naturolie_02.png", TypeOfWood = "Eg", Oil = "Naturolie", WeightInKg = 13.4 }
                );
